...
$res = mysql_query($req) ;
                            ...
                            $promo_id_statut = $ligne->id_statut;
                                    ...
                                    #   echo "<td>$ligne->nom_role</td>";
                                        ...
                                        $req_statut2="SELECT *
                                        FROM utilisateur AS u, poste AS p, poste_utilisateur AS pu, poste_dans_entreprise AS pde, entreprise AS e, entreprise_utilisateur As eu, entreprise_ville AS ev, ville AS vi, pays AS pa, ville_pays AS vp, roles_utilisateur AS ru, role AS r, statut AS s, statut_ancien_etudiant AS sa
                                ...
                                #   $ligne=mysql_fetch_object($res_statut2) ;   
                                        ...
                                        $req_statut3 = "SELECT *
                                        FROM utilisateur AS u, etudes AS e, etudes_utilisateur AS eu, etablissement AS eta, etablissement_utilisateur AS etau, ville AS v, pays AS p, ville_pays AS vp, etablissement_ville AS etav, roles_utilisateur AS ru, role AS r, statut AS s, statut_ancien_etudiant AS sa
