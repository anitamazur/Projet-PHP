...
function connexion()
	{
    $serveurBD = "localhost"; # à modifier pour le serveur de la fac
    $nomUtilisateur = "root"; # à modifier pour le serveur de la fac
    $motDePasse = ""; # à modifier pour le serveur de la fac
...
function debuthtml($titre_head,$titre_header='Annuaire M2 DEFI',$titre_contenu)
	{
